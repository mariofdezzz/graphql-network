...
<template>
  <div class="h-full flex flex-col">
    <div class="shared-table grid gap-px bg-on-base-disabled *:bg-base" :style>
      <SharedTableHeader :columns :sort />

      <div
        v-for="(row, rowIndex) in rows"
        :key="rowIndex"
        class="px-2 py-1 border-b border-on-base-disabled first:border-l last:border-r hover:bg-on-base-hover grid gap-px bg-on-base-disabled *:bg-base"
    ...
    <div class="flex-1 grid gap-px grid-rows-1 bg-on-base-disabled *:bg-base" :style>
